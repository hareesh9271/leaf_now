	...
	?>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">LEAF NOW Farm<span>KARNATAKA BANGALORE</span></p>
			</div>
			<div>
			...
			<div>
				...
				<p style="font-size:20px"><a href="mailto:LEAF NOW@gmail.com" style="color:white">ZULFIQAR@GMAIL.com</a></p>
			</div>
		</div>
		...
		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				...
				LEAF NOW is e-commerce trading platform for grains & grocerries...
			</p>
